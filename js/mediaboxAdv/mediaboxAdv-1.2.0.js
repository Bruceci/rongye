...
(function() {
	...
	window.addEvent("domready", function() {
		...
		bottom = new Element("div", {id: "mbBottom"}).injectInside(center).adopt(
			new Element("div", {id: "mbCloseDiv"}).adopt(new Element("a", {id: "mbCloseLink", href: "#"}).addEvent("click", close)),
			nextLink = new Element("a", {id: "mbNextLink", href: "#"}).addEvent("click", next),
			prevLink = new Element("a", {id: "mbPrevLink", href: "#"}).addEvent("click", previous),
			title = new Element("div", {id: "mbTitle"}),
			caption = new Element("div", {id: "mbCaption"}),
			number = new Element("div", {id: "mbNumber"}),
			closer = new Element("div", {id: "mbCloser"})
		);
...
//			Youtube options
				...
				ytColor1: 'FEFEFE',			// Outline color
				ytColor2: 'D8D8D8',			// Base interface color (highlight colors stay consistent)
...
//					'allowtransparency': 'true',
	...
	function startEffect() {
		...
		var _centerWidth = center.offsetWidth;
		center.setStyles({width: mediaWidth});
		mediaHeight = image.offsetHeight+bottom.offsetHeight;
		center.setStyles({width: _centerWidth});
